...
const InfoModal = ({ visible, onClose, food }) => {
  return (
    <Modal title={food.name} visible={visible} onCancel={onClose} footer={null}>
      <p>
      ...
      <p>
        <strong>Thời gian mở cửa:</strong> {food.openTime}
      </p>
      <p>
        <strong>Thời gian đóng cửa:</strong> {food.closeTime}
      </p>
      <p>
